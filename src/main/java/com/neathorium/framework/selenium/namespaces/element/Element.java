...
import com.neathorium.framework.selenium.constants.Alternatives;
...
import com.neathorium.framework.selenium.records.ActionWhenData;
...
import static com.neathorium.framework.selenium.namespaces.utilities.SeleniumUtilities.isNotNullLazyElementWaitParametersData;
...
public interface Element {
    ...
    static DriverFunction<String> getWhenCore(
        ...
        return isNotNullLazyElementWaitParametersData(data) && CoreUtilities.areNotNull(waiter, getter) && isNotBlank(input) ? (
    ...
    static DriverFunction<String> getWhenCore(
        ...
        return (isNotNullLazyElementWaitParametersData(data) && CoreUtilities.areNotNull(waiter, getter)) ? (
