...
import com.github.karsaii.framework.selenium.namespaces.driver.DevtoolsDriverFunctions;
...
public interface JSInitializer {
    static DriverFunction<Boolean> isJSDependenciesExistData() {
        return ifDriver("isJSDependenciesExistData", DevtoolsDriverFunctions.doBooleanCommand(JSInitializerConstants.DEPENDENCY_EXISTENCE_CHECKER), CoreDataConstants.NULL_BOOLEAN);
    }
